...
public class CustomerBilling extends CustomerBillingFunctions {
	...
	{
		CustomerBilling.drivers = new ArrayList<WebDriver>();
	}
	...
	{ 
		if(browser.equalsIgnoreCase("Firefox"))
		{
			...
			CustomerBilling.drivers.add(driver);
		}
	...
	{ 				
		...
		wrapper.setParameter(ExcelConstants.SHEET_NAME, "Customer Billing");
	...
	/**
	 * Test to check wether expected details are shown in CB screen
	 * @throws Exception 
	 * 
	 */
	@Test(priority=0, dataProvider="databinding")
	public void customerBillingCheckDetails(HashMap<String, String> h) throws Exception
	{
		...
		/* Checking whether the info in the CB screen is as expected */
		cBCheckDetails(driver, h.get("ReferenceNumber"));
