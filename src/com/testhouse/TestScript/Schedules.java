...
import com.testhouse.Functions.SchedulesFunctions;
...
public class Schedules extends SchedulesFunctions
{	
	...
	public Schedules()
	{
		Schedules.drivers = new ArrayList<WebDriver>();
	}
	...
	/**
	 * Test to edit a schedule, go to offer screen from schedule page
	 * @throws Exception 
	 * 
	 */
	@Test(priority=4, dataProvider="databinding")
	public void maintSchedule(HashMap<String, String> h) throws Exception
	{
		ATUReports.setTestCaseReqCoverage("Creating a new standard non optimistic Schedule");
		ATUReports.setAuthorInfo("Automation Tester", Utils.getCurrentTime(),"1.0");	
		...
		/* Creating a new Product Only Schedule */
		maintSchedule(driver, h.get("Client"), h.get("Brand"), h.get("Schedule"), h.get("NewName"), h.get("NewDesc"));	
	}
