...
/**
 * Class file to write the test scripts for the Products scenarios
 * @version 1.0
 * @author Testhouse
 *
 */
@Listeners({ ATUReportsListener.class, ConfigurationListener.class,	MethodListener.class })
public class Products extends ProductFunctions 
{
	...
	public Products()
	{
		Products.drivers = new ArrayList<WebDriver>();
	}
	...
	{ 
		...
		ATUReports.currentRunDescription ="Products";
